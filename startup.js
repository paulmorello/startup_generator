...
var startupCompany = Math.floor((Math.random() * thisArray.length));

var startup = Math.floor((Math.random() * thatArray.length));

console.log('Your startup is like ' + thatArray[startupCompany] + ' you should start something like ' + thisArray[startup]);

var user = prompt('Would you like an idea for a startup?').toUpperCase();
